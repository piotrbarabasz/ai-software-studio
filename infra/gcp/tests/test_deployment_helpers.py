...
@unittest.skipUnless(
    WINDOWS_PREFLIGHT_AVAILABLE,
    "PowerShell preflight integration tests require Windows, powershell.exe and git",
)
class PowerShellPreflightIntegrationTest(unittest.TestCase):
